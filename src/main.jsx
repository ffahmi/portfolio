...
<section className="container pb-28 flex flex-row w-full items-center justify-start gap-x-12 bg-gradient-to-br from-accent/20 to-cyan/10 rounded-[2rem] border border-white/10 p-8 md:p-14 ">
    <div className=" ">
        <p className="eyebrow">Let's create</p><h2 className="mt-4 max-w-2xl text-4xl font-semibold tracking-tight md:text-6xl">Good work starts with a good conversation.</h2>
    
    </div>
    <div>
    <Button to="/contact" className="mt-12">Start a conversation <ArrowUpRight size={17}/></Button>
    </div>
    </section>
</Shell>}
